// ignore_for_file: prefer_const_constructors, file_names, prefer_const_literals_to_create_immutables, sort_child_properties_last, body_might_complete_normally_nullable, avoid_print
...
class AddNewActivity extends StatefulWidget {
  const AddNewActivity({Key? key}) : super(key: key);
                  ...
                  onTap: () async {
                    if (_formKey.currentState!.validate()) {
                      if (textFieldError == false && textFieldErrors == false && ctrlDate.text.isNotEmpty) {
                        ...
                        http
                            .post(Uri.parse(ApiActivity.baseUrl + ApiActivity.usersEndpoint),
